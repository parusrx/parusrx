...
public static partial class Program
{
    ...
    public static void AddCustomHealthCheck(this WebApplicationBuilder builder)
    {
        ...
        hcBuilder.AddUrlGroup(new Uri(
            builder.Configuration["Urls:Suggestions"] + "?_wadl"),
            name: "DaData Suggestions API Endpoint",
            tags: new string[] { "dadataapi", "suggestions" });
    }
    ...
    public static void AddCustomSwagger(this WebApplicationBuilder builder) =>
        builder.Services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "DaData HTTP API",
                Version = "v1",
                Description = "The DaData Microservice HTTP API."
            });
        });
    ...
    public static void AddCustomApplicationServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<ISuggestPartyEventService, SuggestPartyEventService>();
        builder.Services.AddTransient<SuggestionPartyHandler>();
    }
}
