...
public class EmployeePositionBulkDataSyncTaskRequestIntegrationEventHandlerTests
{
    [Fact]
    public async Task HandleAsync_ShouldSaveResponseToStore()
    {
        ...
        var employeePositionBulkDataSyncTaskRequest = new CreateEmployeePositionListBulkDataSyncTaskRequest
        {
            ...
            EmployeePositions = new[]
            {
                new EmployeePositionItem
                {
                    ExternalId = "1",
                    Name = "Test"
                }
        ...
        var bulkDataSyncTaskResponse = new BulkDataSyncTaskResponse
        {
            ...
            {
                Id = taskId,
                Type = BulkDataSyncTaskType.EMPLOYEE_POSITIONS,
                ...
                Data = new List<BulkDataSyncTaskDataItem>
                {
                    new()
                    {
                        ...
                        Result = BulkDataSyncTaskDataItemResult.CREATED
                    }
                },
        ...
        clientMock.Setup(x => x.CreateBulkDataSyncTaskAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CreateBulkDataSyncTaskRequest<EmployeePositionItem>>(), It.IsAny<CancellationToken>())).ReturnsAsync(createBulkDataSyncTaskResponse);
...
#pragma warning disable CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        storeMock.Setup(x => x.ReadDataRequestAsync(@event.Body)).ReturnsAsync(XmlSerializerUtility.Serialize(employeePositionBulkDataSyncTaskRequest));
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        ...
        var loggerMock = new Mock<ILogger<EmployeePositionBulkDataSyncTaskRequestIntegrationEventHandler>>();

        var handler = new EmployeePositionBulkDataSyncTaskRequestIntegrationEventHandler(storeMock.Object, clientMock.Object, loggerMock.Object);
