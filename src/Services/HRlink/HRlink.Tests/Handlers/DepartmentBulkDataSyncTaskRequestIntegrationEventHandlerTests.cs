...
public class DepartmentBulkDataSyncTaskRequestIntegrationEventHandlerTests
{
    [Fact]
    public async Task HandleAsync_ShouldSaveResponseToStore()
    {
        ...
        var departmentBulkDataSyncTaskRequest = new CreateDepartmentListBulkDataSyncTaskRequest
        {
        ...
        var bulkDataSyncTaskResponse = new BulkDataSyncTaskResponse
        {
            ...
            {
                Id = taskId,
                Type = BulkDataSyncTaskType.CLIENT_DEPARTMENTS,
        ...
        clientMock.Setup(x => x.CreateBulkDataSyncTaskAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CreateBulkDataSyncTaskRequest<DepartmentDto>>(), It.IsAny<CancellationToken>())).ReturnsAsync(createBulkDataSyncTaskResponse);
...
#pragma warning disable CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        storeMock.Setup(x => x.ReadDataRequestAsync(It.IsAny<string>())).ReturnsAsync(XmlSerializerUtility.Serialize(departmentBulkDataSyncTaskRequest));
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        ...
        var loggerMock = new Mock<ILogger<DepartmentBulkDataSyncTaskRequestIntegrationEventHandler>>();

        var handler = new DepartmentBulkDataSyncTaskRequestIntegrationEventHandler(storeMock.Object, clientMock.Object, loggerMock.Object);
