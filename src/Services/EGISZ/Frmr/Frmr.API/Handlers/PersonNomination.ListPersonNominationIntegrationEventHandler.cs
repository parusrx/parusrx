...
public sealed class ListPersonNominationIntegrationEventHandler(IParusRxStore store, IPersonNominationService service, ILogger<ListPersonNominationIntegrationEventHandler> logger)
