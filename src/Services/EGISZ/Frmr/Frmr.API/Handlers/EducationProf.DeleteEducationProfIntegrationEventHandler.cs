...
public sealed class DeleteEducationProfIntegrationEventHandler(IParusRxStore store, IEducationProfService service, ILogger<DeleteEducationProfIntegrationEventHandler> logger)
