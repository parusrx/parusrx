...
public sealed class DeletePersonQualificationIntegrationEventHandler(IParusRxStore store, IPersonQualificationService service, ILogger<DeletePersonQualificationIntegrationEventHandler> logger)
