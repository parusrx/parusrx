...
public sealed class GetEducationCommonIntegrationEventHandler(IParusRxStore store, IEducationCommonService service, ILogger<GetEducationCommonIntegrationEventHandler> logger)
