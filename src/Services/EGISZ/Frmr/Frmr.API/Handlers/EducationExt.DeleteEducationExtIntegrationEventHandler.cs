...
public sealed class DeleteEducationExtIntegrationEventHandler(IParusRxStore store, IEducationExtService service, ILogger<DeleteEducationExtIntegrationEventHandler> logger)
