...
public sealed class DeletePersonNominationIntegrationEventHandler(IParusRxStore store, IPersonNominationService service, ILogger<DeletePersonNominationIntegrationEventHandler> logger)
