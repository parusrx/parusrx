...
public sealed class ListPersonCardIntegrationEventHandler(IParusRxStore store, IPersonCardService service, ILogger<ListPersonCardIntegrationEventHandler> logger)
