...
public sealed class UpdateEducationPostgraduateIntegrationEventHandler(IParusRxStore store, IEducationPostgraduateService service, ILogger<UpdateEducationPostgraduateIntegrationEventHandler> logger)
