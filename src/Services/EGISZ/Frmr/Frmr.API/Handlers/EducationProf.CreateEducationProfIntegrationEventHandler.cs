...
public sealed class CreateEducationProfIntegrationEventHandler(IParusRxStore store, IEducationProfService service, ILogger<CreateEducationProfIntegrationEventHandler> logger)
