...
public class DeletePersonIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IPersonService> _serviceMock;
    private readonly Mock<ILogger<DeletePersonIntegrationEventHandler>> _loggerMock;

    public DeletePersonIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IPersonService>();
        _loggerMock = new Mock<ILogger<DeletePersonIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeletePersonIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
