...
public sealed class DeletePersonAccreditationIntegrationEventHandler(IParusRxStore store, IPersonAccreditationService service, ILogger<DeletePersonAccreditationIntegrationEventHandler> logger)
