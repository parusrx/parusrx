...
public sealed class CreatePersonAccreditationIntegrationEventHandler(IParusRxStore store, IPersonAccreditationService service, ILogger<CreatePersonAccreditationIntegrationEventHandler> logger)
