...
public sealed class DeleteEducationPostgraduateIntegrationEventHandler(IParusRxStore store, IEducationPostgraduateService service, ILogger<DeleteEducationPostgraduateIntegrationEventHandler> logger)
