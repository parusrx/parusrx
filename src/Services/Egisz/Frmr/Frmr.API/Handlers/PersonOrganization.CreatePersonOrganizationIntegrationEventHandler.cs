...
public sealed class CreatePersonOrganizationIntegrationEventHandler(IParusRxStore store, IPersonOrganizationService service, ILogger<CreatePersonOrganizationIntegrationEventHandler> logger)
