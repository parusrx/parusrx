...
public sealed class DeleteEducationCertIntegrationEventHandler(IParusRxStore store, IEducationCertService service, ILogger<DeleteEducationCertIntegrationEventHandler> logger)
