...
public sealed class DeleteMilitaryServiceIntegrationEventHandler(IParusRxStore store, IMilitaryClient service, ILogger<DeleteMilitaryServiceIntegrationEventHandler> logger)
