...
public sealed class UpdatePersonQualificationIntegrationEventHandler(IParusRxStore store, IPersonQualificationService service, ILogger<UpdatePersonQualificationIntegrationEventHandler> logger)
