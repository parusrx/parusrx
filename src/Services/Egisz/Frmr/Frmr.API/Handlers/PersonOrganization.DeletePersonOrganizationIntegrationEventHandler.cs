...
public sealed class DeletePersonOrganizationIntegrationEventHandler(IParusRxStore store, IPersonOrganizationService service, ILogger<DeletePersonOrganizationIntegrationEventHandler> logger)
