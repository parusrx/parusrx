...
public sealed class GetMilitaryServiceIntegrationEventHandler(IParusRxStore store, IMilitaryClient service, ILogger<GetMilitaryServiceIntegrationEventHandler> logger)
