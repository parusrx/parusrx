...
public sealed class ListEducationPostgraduateIntegrationEventHandler(IParusRxStore store, IEducationPostgraduateService service, ILogger<ListEducationPostgraduateIntegrationEventHandler> logger)
