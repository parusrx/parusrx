...
public sealed class ListEducationCertIntegrationEventHandler(IParusRxStore store, IEducationCertService service, ILogger<ListEducationCertIntegrationEventHandler> logger)
