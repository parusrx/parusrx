...
public class UpdateEducationCommonIntegrationEventHandler(IParusRxStore store, IEducationCommonService service, ILogger<UpdateEducationCommonIntegrationEventHandler> logger)
