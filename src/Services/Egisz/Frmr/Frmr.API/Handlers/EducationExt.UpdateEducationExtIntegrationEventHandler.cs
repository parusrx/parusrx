...
public sealed class UpdateEducationExtIntegrationEventHandler(IParusRxStore store, IEducationExtService service, ILogger<UpdateEducationExtIntegrationEventHandler> logger)
