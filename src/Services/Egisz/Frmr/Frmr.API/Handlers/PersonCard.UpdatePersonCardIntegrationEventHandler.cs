...
public sealed class UpdatePersonCardIntegrationEventHandler(IParusRxStore store, IPersonCardService service, ILogger<UpdatePersonCardIntegrationEventHandler> logger)
