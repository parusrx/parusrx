...
public sealed class DeletePersonCardIntegrationEventHandler(IParusRxStore store, IPersonCardService service, ILogger<DeletePersonCardIntegrationEventHandler> logger)
