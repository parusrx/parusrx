...
public class UpdateEducationCertIntegrationEventHandler(IParusRxStore store, IEducationCertService service, ILogger<UpdateEducationCertIntegrationEventHandler> logger)
