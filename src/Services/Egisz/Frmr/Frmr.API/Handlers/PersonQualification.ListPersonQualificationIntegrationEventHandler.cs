...
public sealed class ListPersonQualificationIntegrationEventHandler(IParusRxStore store, IPersonQualificationService service, ILogger<ListPersonQualificationIntegrationEventHandler> logger)
