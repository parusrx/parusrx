...
public sealed class UpdatePersonNominationIntegrationEventHandler(IParusRxStore store, IPersonNominationService service, ILogger<UpdatePersonNominationIntegrationEventHandler> logger)
