...
public sealed class GetPersonAccreditationIntegrationEventHandler(IParusRxStore store, IPersonAccreditationService service, ILogger<GetPersonAccreditationIntegrationEventHandler> logger)
