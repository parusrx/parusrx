...
public sealed class ListPersonOrganizationIntegrationEventHandler(IParusRxStore store, IPersonOrganizationService service, ILogger<ListPersonOrganizationIntegrationEventHandler> logger)
