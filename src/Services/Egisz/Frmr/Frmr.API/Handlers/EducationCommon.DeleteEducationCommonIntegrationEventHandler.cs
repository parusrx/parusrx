...
public class DeleteEducationCommonIntegrationEventHandler(IParusRxStore store, IEducationCommonService service, ILogger<DeleteEducationCommonIntegrationEventHandler> logger)
