...
public sealed class CreateMilitaryServiceIntegrationEventHandler(IParusRxStore store, IMilitaryClient service, ILogger<CreateMilitaryServiceIntegrationEventHandler> logger)
