...
public sealed class DeleteEquipmentIntegrationEventHandler(
    IParusRxStore store,
    IEquipmentService service,
    ILogger<DeleteEquipmentIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
