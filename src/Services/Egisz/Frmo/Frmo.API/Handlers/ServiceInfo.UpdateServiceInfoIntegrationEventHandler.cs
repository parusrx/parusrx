...
public sealed class UpdateServiceInfoIntegrationEventHandler(IParusRxStore store, IServiceInfoService service, ILogger<UpdateServiceInfoIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
