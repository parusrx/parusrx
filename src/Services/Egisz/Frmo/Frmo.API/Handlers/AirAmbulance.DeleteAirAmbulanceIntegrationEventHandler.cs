...
public sealed class DeleteAirAmbulanceIntegrationEventHandler(
    IParusRxStore store,
    IAirAmbulanceService service,
    ILogger<DeleteAirAmbulanceIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
