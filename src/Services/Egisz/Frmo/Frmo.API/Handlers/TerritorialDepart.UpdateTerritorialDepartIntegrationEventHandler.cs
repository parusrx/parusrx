...
public sealed class UpdateTerritorialDepartIntegrationEventHandler(
    IParusRxStore store,
    ITerritorialDepartService service,
    ILogger<UpdateTerritorialDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
