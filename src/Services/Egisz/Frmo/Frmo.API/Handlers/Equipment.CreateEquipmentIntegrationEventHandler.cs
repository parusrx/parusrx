...
public sealed class CreateEquipmentIntegrationEventHandler(
    IParusRxStore store,
    IEquipmentService service,
    ILogger<CreateEquipmentIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
