...
public sealed class GetTerritorialDepartIntegrationEventHandler(
    IParusRxStore store,
    ITerritorialDepartService service,
    ILogger<GetTerritorialDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
