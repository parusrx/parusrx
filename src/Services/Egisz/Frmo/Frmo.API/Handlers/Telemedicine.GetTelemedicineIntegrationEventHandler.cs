...
public sealed class GetTelemedicineIntegrationEventHandler(IParusRxStore store, ITelemedicineService service, ILogger<GetTelemedicineIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
