...
public sealed class ListMobileDepartIntegrationEventHandler(
    IParusRxStore store,
    IMobileDepartService service,
    ILogger<ListMobileDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
