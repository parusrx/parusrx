...
public sealed class ListEquipmentIntegrationEventHandler(
    IParusRxStore store,
    IEquipmentService service,
    ILogger<ListEquipmentIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
