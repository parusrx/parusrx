...
public sealed class UpdateSiteIntegrationEventHandler(IParusRxStore store, ISiteService service, ILogger<UpdateSiteIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
