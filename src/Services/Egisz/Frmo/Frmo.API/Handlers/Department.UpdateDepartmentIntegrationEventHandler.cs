...
public sealed class UpdateDepartmentIntegrationEventHandler(
    IParusRxStore store, 
    IDepartmentService service, 
    ILogger<UpdateDepartmentIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
