...
public sealed class GetSiteIntegrationEventHandler(IParusRxStore store, ISiteService service, ILogger<GetSiteIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
