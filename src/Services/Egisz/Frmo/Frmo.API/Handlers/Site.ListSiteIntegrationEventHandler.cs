...
public sealed class ListSiteIntegrationEventHandler(IParusRxStore store, ISiteService service, ILogger<ListSiteIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
