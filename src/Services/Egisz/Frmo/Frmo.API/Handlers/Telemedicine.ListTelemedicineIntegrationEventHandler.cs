...
public sealed class ListTelemedicineIntegrationEventHandler(IParusRxStore store, ITelemedicineService service, ILogger<ListTelemedicineIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
