...
public sealed class UpdateBuildingIntegrationEventHandler(IParusRxStore store, IBuildingService service, ILogger<UpdateBuildingIntegrationEventHandler> logger)
