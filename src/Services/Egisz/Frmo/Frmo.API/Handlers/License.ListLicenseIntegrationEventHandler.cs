...
public sealed class ListLicenseIntegrationEventHandler(IParusRxStore store, ILicenseService service, ILogger<ListLicenseIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
