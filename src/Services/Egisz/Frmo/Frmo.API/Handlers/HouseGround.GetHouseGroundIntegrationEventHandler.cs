...
public sealed class GetHouseGroundIntegrationEventHandler(
    IParusRxStore store,
    IHouseGroundService service,
    ILogger<GetHouseGroundIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
