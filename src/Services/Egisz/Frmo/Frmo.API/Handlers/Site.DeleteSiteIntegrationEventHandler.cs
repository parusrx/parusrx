...
public sealed class DeleteSiteIntegrationEventHandler(IParusRxStore store, ISiteService service, ILogger<DeleteSiteIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
