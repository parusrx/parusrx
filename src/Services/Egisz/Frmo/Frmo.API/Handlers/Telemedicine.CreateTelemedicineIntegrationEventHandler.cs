...
public sealed class CreateTelemedicineIntegrationEventHandler(IParusRxStore store, ITelemedicineService service, ILogger<CreateTelemedicineIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
