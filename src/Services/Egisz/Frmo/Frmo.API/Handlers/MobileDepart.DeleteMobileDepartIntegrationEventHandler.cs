...
public sealed class DeleteMobileDepartIntegrationEventHandler(
    IParusRxStore store,
    IMobileDepartService service,
    ILogger<DeleteMobileDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
