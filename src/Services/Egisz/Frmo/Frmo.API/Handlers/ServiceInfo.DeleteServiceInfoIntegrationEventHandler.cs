...
public sealed class DeleteServiceInfoIntegrationEventHandler(IParusRxStore store, IServiceInfoService service, ILogger<DeleteServiceInfoIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
