...
public sealed class ListPagedDepartmentIntegrationEventHandler(
    IParusRxStore store, 
    IDepartmentService service, 
    ILogger<ListPagedDepartmentIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
