...
public sealed class GetMobileDepartIntegrationEventHandler(
    IParusRxStore store,
    IMobileDepartService service,
    ILogger<GetMobileDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
