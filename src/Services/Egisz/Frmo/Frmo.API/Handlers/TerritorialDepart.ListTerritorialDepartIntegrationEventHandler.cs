...
public sealed class ListTerritorialDepartIntegrationEventHandler(
    IParusRxStore store,
    ITerritorialDepartService service,
    ILogger<ListTerritorialDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
