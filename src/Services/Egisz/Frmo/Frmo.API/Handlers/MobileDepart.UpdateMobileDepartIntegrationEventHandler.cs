...
public sealed class UpdateMobileDepartIntegrationEventHandler(
    IParusRxStore store,
    IMobileDepartService service,
    ILogger<UpdateMobileDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
