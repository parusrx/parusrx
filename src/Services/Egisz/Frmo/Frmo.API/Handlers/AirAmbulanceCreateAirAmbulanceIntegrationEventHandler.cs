...
public sealed class CreateAirAmbulanceIntegrationEventHandler(
    IParusRxStore store,
    IAirAmbulanceService service,
    ILogger<CreateAirAmbulanceIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
