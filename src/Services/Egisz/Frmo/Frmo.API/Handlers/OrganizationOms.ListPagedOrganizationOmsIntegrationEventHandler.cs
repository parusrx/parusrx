...
public sealed class ListPagedOrganizationOmsIntegrationEventHandler(
    IParusRxStore store,
    IOrganizationOmsService service,
    ILogger<ListPagedOrganizationOmsIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
