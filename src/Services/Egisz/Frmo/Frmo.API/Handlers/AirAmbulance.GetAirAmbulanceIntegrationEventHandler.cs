...
public sealed class GetAirAmbulanceIntegrationEventHandler(
    IParusRxStore store,
    IAirAmbulanceService service,
    ILogger<GetAirAmbulanceIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
