...
public sealed class ListPagedDepartmentOmsIntegrationEventHandler(
    IParusRxStore store,
    IDepartmentOmsService service,
    ILogger<ListPagedDepartmentOmsIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
