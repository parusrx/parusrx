...
public sealed class ListEducationOrganizationDepartIntegrationEventHandler(IParusRxStore store, IEducationOrganizationDepartService service, ILogger<ListEducationOrganizationDepartIntegrationEventHandler> logger)
