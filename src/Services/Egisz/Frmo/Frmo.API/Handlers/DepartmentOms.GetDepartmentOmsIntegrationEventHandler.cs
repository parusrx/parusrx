...
public sealed class GetDepartmentOmsIntegrationEventHandler(
    IParusRxStore store,
    IDepartmentOmsService service,
    ILogger<GetDepartmentOmsIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
