...
public sealed class ListServiceInfoIntegrationEventHandler(IParusRxStore store, IServiceInfoService service, ILogger<ListServiceInfoIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
