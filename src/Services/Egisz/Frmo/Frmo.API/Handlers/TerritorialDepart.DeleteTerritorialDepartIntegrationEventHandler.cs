...
public sealed class DeleteTerritorialDepartIntegrationEventHandler(
    IParusRxStore store,
    ITerritorialDepartService service,
    ILogger<DeleteTerritorialDepartIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
