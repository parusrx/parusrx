...
public sealed class DeleteBuildingIntegrationEventHandler(IParusRxStore store, IBuildingService service, ILogger<DeleteBuildingIntegrationEventHandler> logger)
