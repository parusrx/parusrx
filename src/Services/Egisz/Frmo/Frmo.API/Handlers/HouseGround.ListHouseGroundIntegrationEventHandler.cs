...
public sealed class ListHouseGroundIntegrationEventHandler(
    IParusRxStore store,
    IHouseGroundService service,
    ILogger<ListHouseGroundIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
