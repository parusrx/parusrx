...
public sealed class CreateBuildingIntegrationEventHandler(IParusRxStore store, IBuildingService service, ILogger<CreateBuildingIntegrationEventHandler> logger)
