...
public sealed class UpdateEducationOrganizationDepartIntegrationEventHandler(IParusRxStore store, IEducationOrganizationDepartService service, ILogger<UpdateEducationOrganizationDepartIntegrationEventHandler> logger)
