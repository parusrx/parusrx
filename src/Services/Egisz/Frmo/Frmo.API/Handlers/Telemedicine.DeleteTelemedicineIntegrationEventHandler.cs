...
public sealed class DeleteTelemedicineIntegrationEventHandler(IParusRxStore store, ITelemedicineService service, ILogger<DeleteTelemedicineIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
