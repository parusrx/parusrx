...
public sealed class UpdateOrganizationIntegrationEventHandler(IParusRxStore store, IOrganizationService service, ILogger<UpdateOrganizationIntegrationEventHandler> logger)
