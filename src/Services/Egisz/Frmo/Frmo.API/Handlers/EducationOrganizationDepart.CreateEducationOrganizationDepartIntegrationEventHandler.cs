...
public sealed class CreateEducationOrganizationDepartIntegrationEventHandler(IParusRxStore store, IEducationOrganizationDepartService service, ILogger<CreateEducationOrganizationDepartIntegrationEventHandler> logger)
