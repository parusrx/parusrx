...
public sealed class GetLicenseIntegrationEventHandler(IParusRxStore store, ILicenseService service, ILogger<GetLicenseIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
