...
public sealed class DeleteHouseGroundIntegrationEventHandler(
    IParusRxStore store,
    IHouseGroundService service,
    ILogger<DeleteHouseGroundIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
