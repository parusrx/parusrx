...
public sealed class ListAirAmbulanceIntegrationEventHandler(
    IParusRxStore store,
    IAirAmbulanceService service,
    ILogger<ListAirAmbulanceIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
