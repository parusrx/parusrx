...
public sealed class UpdateHouseGroundIntegrationEventHandler(
    IParusRxStore store,
    IHouseGroundService service,
    ILogger<UpdateHouseGroundIntegrationEventHandler> logger) : IIntegrationEventHandler<MqIntegrationEvent>
{
