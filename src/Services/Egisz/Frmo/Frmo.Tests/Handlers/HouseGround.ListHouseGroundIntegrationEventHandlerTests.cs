...
public class ListHouseGroundIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IHouseGroundService> _serviceMock;
    private readonly Mock<ILogger<ListHouseGroundIntegrationEventHandler>> _loggerMock;

    public ListHouseGroundIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IHouseGroundService>();
        _loggerMock = new Mock<ILogger<ListHouseGroundIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<HouseGround>()
        {
        ...
        var handler = new ListHouseGroundIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
