...
public class GetTerritorialDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITerritorialDepartService> _serviceMock;
    private readonly Mock<ILogger<GetTerritorialDepartIntegrationEventHandler>> _loggerMock;

    public GetTerritorialDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITerritorialDepartService>();
        _loggerMock = new Mock<ILogger<GetTerritorialDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new SingleResponse<TerritorialDepart>()
        {
            RequestId = Guid.NewGuid().ToString(),
            Content = new TerritorialDepart()
            {
                MoTerritorialDepartId = Guid.NewGuid().ToString()
            }
        };
        ...
        var handler = new GetTerritorialDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
