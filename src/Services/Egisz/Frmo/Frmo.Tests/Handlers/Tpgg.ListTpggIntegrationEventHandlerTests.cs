...
public class ListTpggIntegrationEventHandlerTests 
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITpggService> _serviceMock;
    private readonly Mock<ILogger<ListTpggIntegrationEventHandler>> _loggerMock;

    public ListTpggIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITpggService>();
        _loggerMock = new Mock<ILogger<ListTpggIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<Tpgg>()
        {
        ...
        var handler = new ListTpggIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
