...
public class DeleteHouseGroundIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IHouseGroundService> _serviceMock;
    private readonly Mock<ILogger<DeleteHouseGroundIntegrationEventHandler>> _loggerMock;

    public DeleteHouseGroundIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IHouseGroundService>();
        _loggerMock = new Mock<ILogger<DeleteHouseGroundIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteHouseGroundIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
