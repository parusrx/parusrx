...
public class ListAirAmbulanceIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IAirAmbulanceService> _serviceMock;
    private readonly Mock<ILogger<ListAirAmbulanceIntegrationEventHandler>> _loggerMock;

    public ListAirAmbulanceIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IAirAmbulanceService>();
        _loggerMock = new Mock<ILogger<ListAirAmbulanceIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<AirAmbulance>()
        {
        ...
        var handler = new ListAirAmbulanceIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
