...
public class GetBuildingIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IBuildingService> _serviceMock;
    private readonly Mock<ILogger<GetBuildingIntegrationEventHandler>> _loggerMock;

    public GetBuildingIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IBuildingService>();
        _loggerMock = new Mock<ILogger<GetBuildingIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new SingleResponse<Building>()
        {
        ...
        var handler = new GetBuildingIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
