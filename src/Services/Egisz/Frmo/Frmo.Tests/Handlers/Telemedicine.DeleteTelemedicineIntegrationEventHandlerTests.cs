...
public class DeleteTelemedicineIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITelemedicineService> _serviceMock;
    private readonly Mock<ILogger<DeleteTelemedicineIntegrationEventHandler>> _loggerMock;

    public DeleteTelemedicineIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITelemedicineService>();
        _loggerMock = new Mock<ILogger<DeleteTelemedicineIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteTelemedicineIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
