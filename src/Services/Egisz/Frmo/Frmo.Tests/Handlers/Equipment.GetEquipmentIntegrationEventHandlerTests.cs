...
public class GetEquipmentIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IEquipmentService> _serviceMock;
    private readonly Mock<ILogger<GetEquipmentIntegrationEventHandler>> _loggerMock;

    public GetEquipmentIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IEquipmentService>();
        _loggerMock = new Mock<ILogger<GetEquipmentIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new SingleResponse<Equipment>()
        {
        ...
        var handler = new GetEquipmentIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
