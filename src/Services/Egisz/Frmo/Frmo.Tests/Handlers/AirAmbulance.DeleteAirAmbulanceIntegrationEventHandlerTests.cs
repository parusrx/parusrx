...
public class DeleteAirAmbulanceIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IAirAmbulanceService> _serviceMock;
    private readonly Mock<ILogger<DeleteAirAmbulanceIntegrationEventHandler>> _loggerMock;

    public DeleteAirAmbulanceIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IAirAmbulanceService>();
        _loggerMock = new Mock<ILogger<DeleteAirAmbulanceIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteAirAmbulanceIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
