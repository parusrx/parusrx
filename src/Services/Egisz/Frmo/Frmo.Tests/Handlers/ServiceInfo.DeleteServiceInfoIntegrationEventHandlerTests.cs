...
public class DeleteServiceInfoIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IServiceInfoService> _serviceMock;
    private readonly Mock<ILogger<DeleteServiceInfoIntegrationEventHandler>> _loggerMock;

    public DeleteServiceInfoIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IServiceInfoService>();
        _loggerMock = new Mock<ILogger<DeleteServiceInfoIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteServiceInfoIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
