...
public class ListMobileDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IMobileDepartService> _serviceMock;
    private readonly Mock<ILogger<ListMobileDepartIntegrationEventHandler>> _loggerMock;

    public ListMobileDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IMobileDepartService>();
        _loggerMock = new Mock<ILogger<ListMobileDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<MobileDepart>()
        {
        ...
        var handler = new ListMobileDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
