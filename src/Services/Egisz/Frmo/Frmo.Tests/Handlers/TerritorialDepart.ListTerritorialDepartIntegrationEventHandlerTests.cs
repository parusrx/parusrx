...
public class ListTerritorialDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITerritorialDepartService> _serviceMock;
    private readonly Mock<ILogger<ListTerritorialDepartIntegrationEventHandler>> _loggerMock;

    public ListTerritorialDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITerritorialDepartService>();
        _loggerMock = new Mock<ILogger<ListTerritorialDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<TerritorialDepart>()
        {
            RequestId = Guid.NewGuid().ToString(),
            Content =
            [
                new TerritorialDepart()
                {
        ...
        var handler = new ListTerritorialDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
