...
public class DeleteMobileDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IMobileDepartService> _serviceMock;
    private readonly Mock<ILogger<DeleteMobileDepartIntegrationEventHandler>> _loggerMock;

    public DeleteMobileDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IMobileDepartService>();
        _loggerMock = new Mock<ILogger<DeleteMobileDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteMobileDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
