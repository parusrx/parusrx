...
public class DeleteSiteIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ISiteService> _serviceMock;
    private readonly Mock<ILogger<DeleteSiteIntegrationEventHandler>> _loggerMock;

    public DeleteSiteIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ISiteService>();
        _loggerMock = new Mock<ILogger<DeleteSiteIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteSiteIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
