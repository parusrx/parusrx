...
public class ListBuildingIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IBuildingService> _serviceMock;
    private readonly Mock<ILogger<ListBuildingIntegrationEventHandler>> _loggerMock;

    public ListBuildingIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IBuildingService>();
        _loggerMock = new Mock<ILogger<ListBuildingIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<Building>()
        {
        ...
        var handler = new ListBuildingIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
