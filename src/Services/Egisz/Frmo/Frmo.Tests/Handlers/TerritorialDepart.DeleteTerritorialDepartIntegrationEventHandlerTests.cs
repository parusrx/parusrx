...
public class DeleteTerritorialDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITerritorialDepartService> _serviceMock;
    private readonly Mock<ILogger<DeleteTerritorialDepartIntegrationEventHandler>> _loggerMock;

    public DeleteTerritorialDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITerritorialDepartService>();
        _loggerMock = new Mock<ILogger<DeleteTerritorialDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var handler = new DeleteTerritorialDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
