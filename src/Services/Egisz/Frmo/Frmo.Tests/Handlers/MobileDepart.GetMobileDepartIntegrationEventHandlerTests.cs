...
public class GetMobileDepartIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IMobileDepartService> _serviceMock;
    private readonly Mock<ILogger<GetMobileDepartIntegrationEventHandler>> _loggerMock;

    public GetMobileDepartIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IMobileDepartService>();
        _loggerMock = new Mock<ILogger<GetMobileDepartIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new SingleResponse<MobileDepart>()
        {
            RequestId = Guid.NewGuid().ToString(),
            Content = new MobileDepart
            {
                MobileDepartId = Guid.NewGuid().ToString()
            }
        };
        ...
        var handler = new GetMobileDepartIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
