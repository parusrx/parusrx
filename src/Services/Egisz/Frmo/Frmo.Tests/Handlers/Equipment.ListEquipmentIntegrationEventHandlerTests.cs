...
public class ListEquipmentIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<IEquipmentService> _serviceMock;
    private readonly Mock<ILogger<ListEquipmentIntegrationEventHandler>> _loggerMock;

    public ListEquipmentIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<IEquipmentService>();
        _loggerMock = new Mock<ILogger<ListEquipmentIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<Equipment>()
        {
        ...
        var handler = new ListEquipmentIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
