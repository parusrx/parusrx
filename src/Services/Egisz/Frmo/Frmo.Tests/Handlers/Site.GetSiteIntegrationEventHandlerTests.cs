...
public class GetSiteIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ISiteService> _serviceMock;
    private readonly Mock<ILogger<GetSiteIntegrationEventHandler>> _loggerMock;

    public GetSiteIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ISiteService>();
        _loggerMock = new Mock<ILogger<GetSiteIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new SingleResponse<Site>()
        {
        ...
        var handler = new GetSiteIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
