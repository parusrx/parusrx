...
public class ListLicenseIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ILicenseService> _serviceMock;
    private readonly Mock<ILogger<ListLicenseIntegrationEventHandler>> _loggerMock;

    public ListLicenseIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ILicenseService>();
        _loggerMock = new Mock<ILogger<ListLicenseIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<License>()
        {
        ...
        var handler = new ListLicenseIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
