...
public class ListTelemedicineIntegrationEventHandlerTests
{
    private readonly Mock<IParusRxStore> _storeMock;
    private readonly Mock<ITelemedicineService> _serviceMock;
    private readonly Mock<ILogger<ListTelemedicineIntegrationEventHandler>> _loggerMock;

    public ListTelemedicineIntegrationEventHandlerTests()
    {
        _storeMock = new Mock<IParusRxStore>();
        _serviceMock = new Mock<ITelemedicineService>();
        _loggerMock = new Mock<ILogger<ListTelemedicineIntegrationEventHandler>>();
    }
    ...
    public async Task HandleAsync_WithValidRequest_SaveDataResponse()
    {
        ...
        var response = new ListResponse<Telemedicine>()
        {
        ...
        var handler = new ListTelemedicineIntegrationEventHandler(_storeMock.Object, _serviceMock.Object, _loggerMock.Object);
