...
public class BuildingServiceTests
{
    ...
    public BuildingServiceTests()
    {
        ...
        _service = new BuildingService(httpClient);
    }

    [Fact]
    public async Task ListAsync_ShouldReturnBuildingResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new ListResponse<Building>();
    ...
    [Fact]
    public async Task GetAsync_ShouldReturnBuildingResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new SingleResponse<Building>();
    ...
    [Fact]
    public async Task CreateAsync_ShouldReturnCreateBuildingResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        ...
        // Act
        var response = await _service.CreateAsync(queryParameters, building, CancellationToken.None);
    ...
    public async Task CreateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.CreateAsync(queryParameters, building, CancellationToken.None));
    ...
    [Fact]
    public async Task UpdateAsync_ShouldReturnUpdateBuildingResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var building = new Building();
        ...
        // Act
        var response = await _service.UpdateAsync(queryParameters, building, CancellationToken.None);
    ...
    public async Task UpdateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.UpdateAsync(queryParameters, building, CancellationToken.None));
    ...
    [Fact]
    public async Task DeleteAsync_ShouldReturnDeleteBuildingResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new DefaultResponse();
