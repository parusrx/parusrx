...
public class SiteServiceTests
{
    ...
    public SiteServiceTests()
    {
        ...
        _service = new SiteService(httpClient);
    }

    [Fact]
    public async Task ListAsync_ShouldReturnSiteResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new ListResponse<Site>();
    ...
    [Fact]
    public async Task GetAsync_ShouldReturnSiteResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new SingleResponse<Site>();
    ...
    [Fact]
    public async Task CreateAsync_ShouldReturnCreateSiteResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var site = new Site();
        ...
        // Act
        var response = await _service.CreateAsync(queryParameters, site, CancellationToken.None);
    ...
    public async Task CreateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.CreateAsync(queryParameters, site, CancellationToken.None));
    ...
    [Fact]
    public async Task UpdateAsync_ShouldReturnUpdateSiteResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var site = new Site();
        ...
        // Act
        var response = await _service.UpdateAsync(queryParameters, site, CancellationToken.None);
    ...
    public async Task UpdateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.UpdateAsync(queryParameters, site, CancellationToken.None));
    ...
    [Fact]
    public async Task DeleteAsync_ShouldReturnDeleteSiteResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new DefaultResponse();
