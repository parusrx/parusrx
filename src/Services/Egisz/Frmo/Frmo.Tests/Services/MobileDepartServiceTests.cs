...
public class MobileDepartServiceTests
{
    private readonly Mock<HttpMessageHandler> _httpMessageHandlerMock;
    private readonly MobileDepartService _service;

    public MobileDepartServiceTests()
    {
        ...
        _service = new MobileDepartService(httpClient);
    }

    [Fact]
    public async Task ListAsync_ShouldReturnMobileDepartResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new ListResponse<MobileDepart>();
    ...
    [Fact]
    public async Task GetAsync_ShouldReturnMobileDepartResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new SingleResponse<MobileDepart>();
    ...
    [Fact]
    public async Task CreateAsync_ShouldReturnCreateMobileDepartResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var mobileDepart = new MobileDepart();
        ...
        // Act
        var response = await _service.CreateAsync(queryParameters, mobileDepart, CancellationToken.None);
    ...
    public async Task CreateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.CreateAsync(queryParameters, mobileDepart, CancellationToken.None));
    ...
    [Fact]
    public async Task UpdateAsync_ShouldReturnUpdateMobileDepartResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var mobileDepart = new MobileDepart();
        ...
        // Act
        var response = await _service.UpdateAsync(queryParameters, mobileDepart, CancellationToken.None);
    ...
    public async Task UpdateAsync_ShouldThrowHttpResponseException_WhenRequestIsNotSuccessful()
    {
        ...
        // Act
        var exception = await Assert.ThrowsAsync<HttpResponseException>(async () => await _service.UpdateAsync(queryParameters, mobileDepart, CancellationToken.None));
    ...
    [Fact]
    public async Task DeleteAsync_ShouldReturnDeleteMobileDepartResponse_WhenRequestIsSuccessful()
    {
        // Arrange
        var queryParameters = new Dictionary<string, string?> { { "key", "value" } };
        var expectedResponse = new DefaultResponse();
