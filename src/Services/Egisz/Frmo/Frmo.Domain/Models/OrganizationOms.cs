...
public record OrganizationOms
{
    ...
    [XmlArray("additionalAgreementOms")]
    [XmlArrayItem("additionalAgreementOmsItem")]
    [JsonPropertyName("additionalAgreementOms")]
    public AdditionalAgreementOms[]? AdditionalAgreementOms { get; init; }

    [XmlArray("horizontalCalculations")]
    [XmlArrayItem("horizontalCalculationsItem")]
    [JsonPropertyName("horizontalCalculations")]
    public HorizontalCalculation[]? HorizontalCalculations { get; init; }
}
